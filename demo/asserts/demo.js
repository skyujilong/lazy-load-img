...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by sina on 2016/5/18.
	 */
	var lazyLoad = __webpack_require__(1);
	console.log(lazyLoad);
	new lazyLoad().init({}, 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = function () {
	    function Loader() {
	        ...
	        var container = arguments.length <= 2 || arguments[2] === undefined ? window.body : arguments[2];
	    ...
	    (0, _createClass3.default)(Loader, [{
	        ...
	        value: function isInView(el) {
	            ...
	            if (offsetHeight - _offset <= $elOffset.top && offsetHeight + viewportHeight + _offset >= $elOffset.top) {
	                return true;
	            } else {
	                return false;
	            }
